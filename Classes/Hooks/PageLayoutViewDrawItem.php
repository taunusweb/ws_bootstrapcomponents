<?php
namespace WSBOOTSTRAPCOMPONENTS\WsBootstrapcomponents\Hooks;
...
class PageLayoutViewDrawItem implements PageLayoutViewDrawItemHookInterface
{
  ...
  0 => 'wsbootstrapcomponents_accordion',
  1 => 'wsbootstrapcomponents_carddeck',
  2 => 'wsbootstrapcomponents_cards',
  3 => 'wsbootstrapcomponents_carousel',
  4 => 'wsbootstrapcomponents_jumbotron',
  5 => 'wsbootstrapcomponents_modal',
);
