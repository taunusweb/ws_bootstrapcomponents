...
class TcaColPosItem implements FormDataProviderInterface
{
  ...
  0 => 'tx_wsbootstrapcomponents_accordioncontent_parent',
  1 => 'tx_wsbootstrapcomponents_modalcontent_parent',
);
    ...
    public function addData(array $result)
    {
        ...
        array_unshift(
            $result['processedTca']['columns']['colPos']['config']['items'],
            [
                'LLL:EXT:ws_bootstrapcomponents/Resources/Private/Language/locallang_db.xlf:tt_content.colPos.nestedContentColPos',
